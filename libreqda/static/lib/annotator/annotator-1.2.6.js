...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.citationIdStr = 'cit-id-';//TODO:vars
    
    Annotator.prototype.activeCitationId = null;
    ...
    //TODO: methods
    Annotator.prototype.hideAllAnnotations = function() {
      $('.annotator-hl').removeClass('annotator-hl');
    };
    
    Annotator.prototype.showAnnotation = function(citationID, keepOn) {
      var selector = '*[name="' + this.citationIdStr + citationID + '"]';
      $(selector).addClass('annotator-hl');
      if (keepOn) {
        this.activeCitationId = citationID;
      }
    };
    
    Annotator.prototype.hideAnnotation = function(citationID) {
      if (!(this.activeCitationId == citationID)) {
        var selector = '*[name="' + this.citationIdStr + citationID + '"]';
        $(selector).removeClass('annotator-hl');
      }
    };
    ...
    Annotator.prototype.highlightRange = function(normedRange, cssClass, aID) {
      var hl, node, white, _k, _len3, _ref2, _results;
      if (cssClass == null) cssClass = 'annotator-hl';
      if (aID == null) aID = 'NaN';
      white = /^\s*$/;
      hl = $("<span class='" + cssClass + "'></span>");
      hl.attr("name", this.citationIdStr + aID);
    ...
    Annotator.prototype.highlightRanges = function(normedRanges, cssClass, aID) {
      var highlights, r, _k, _len3;
      if (cssClass == null) cssClass = 'annotator-hl';
      highlights = [];
      for (_k = 0, _len3 = normedRanges.length; _k < _len3; _k++) {
        r = normedRanges[_k];
        $.merge(highlights, this.highlightRange(r, cssClass, aID));
      }
      return highlights;
    };
    ...
    Annotator.prototype.onAdderClick = function(event) {
      ...
      if (this.selectedRanges && this.selectedRanges.length) {
        ...
        highlights = this.highlightRanges(ranges, 'annotator-hl annotator-hl-temporary', null);
